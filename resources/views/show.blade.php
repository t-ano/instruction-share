<x-layout>
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <form method="post" action="{{ route('destroy', ['instruction' => $instruction]) }}" name="destroyForm{{$instruction->id}}" >
            @csrf
            <button class="bg-transparent hover:bg-blue-500 text-blue-700 hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded mr-5"><a href="{{ route('edit', ['instruction' => $instruction]) }}">編集</a></button>
